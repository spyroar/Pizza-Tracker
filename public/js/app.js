...
function placeOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/orders', formObject).then(function (res) {
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: "success",
      timeout: 1000,
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, paymentType, card, mountWidget, paymentForm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51MUm48SBHezlxcf4YwdBFb2urSeoCkkZ2OK4RLkURGz7qYA2z7cUDqcckQetcppG2bAquozds8Q2JP44uEryjdac00W3Iehmkx');
        case 3:
